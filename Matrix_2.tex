...
\\
\vec{c} = \frac{1}{2}\myvec{\norm{A}^2 -\norm{B}^2 & \norm{B}^2 - \norm{C}^2} \label{eqref_c}
\end{align}
by substituting \vec{A} ,\vec{B} and \vec{C} in \eqref{eqref_N} and \eqref{eqref_c} we get
\begin{align}
\vec{N} = \myvec{-1&4 \\ -2&1} \nonumber \\
\vec{N}^{-T}=\myvec{1/7 &-4/7 \\2/7 &-1/7} \label{eqA} \\ 
\vec{c}=\frac{1}{2}\myvec{(2 -13)  & (13-8)} = \myvec{-11/2 & 5/2} \label{eqB} \\
\text from \eqref{eqA} and \eqref{eqB} we get  \nonumber \\
